...
\[
    \begin{cases}
        ...
        V_{BF} = I \times R_{BF}=18 \times 3=54(V) \Rightarrow V_{B}=V_{F}+V_{BF}=0+54=54(V) \\
    \end{cases}
\]
By applying the voltage divider rule, we have:
\vspace{-0.15cm}
\[
    V_{EF} = V_{BF} \times \dfrac{R7}{R_{BE}+R7}=54 \times \dfrac{9}{3+9}=40.5(V) \Rightarrow V_{E}=V_{F}+V_{EF}=0+40.5=40.5(V)                                                            \\
\]
\[
    \begin{aligned}
        V_{CE}      = & V_{BE} \times \dfrac{R_{CE}}{R_{CE}+R_{DE}}= (V_B-V_E)\times \dfrac{R_{CE}}{R_{CE}+R_{DE}}= (54-40.5) \times \dfrac{4}{4+2}=9(V) \\
        \Rightarrow   & V_{C}=V_{E}+V_{CE}=40.5+9=49.5(V)
    \end{aligned}
\]
\[
    \begin{aligned}
        V_{DE}      = & V_{CE} \times \dfrac{R_{DE}}{R_{DE}+R_{3}}= (V_C-V_E) \times \dfrac{R_{DE}}{R_{DE}+R_{3}}= (49.5-40.5) \times \dfrac{2}{2+10}=1.5(V) \\
