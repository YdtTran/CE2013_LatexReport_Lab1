...
\vspace{-0.15cm}
\begin{align*}
    I_2 & = I_1 \cdot \frac{6}{6+3+3} = 1 \cdot \frac{6}{12} = 0.5 (mA)   \\
    I_3 & = I_1 \cdot \frac{3+3}{6+3+3} = 1 \cdot \frac{6}{12} = 0.5 (mA)
\end{align*}
By applying Ohm's law, we can find $V_a$ and $V_b$:
\vspace{-0.15cm}
\begin{align*}
    V_a & = I_2 \cdot 6 = 0.5 \cdot 6 = 3 (V)   \\
    V_b & = I_3 \cdot 3 = 0.5 \cdot 3 = 1.5 (V)
\end{align*}
